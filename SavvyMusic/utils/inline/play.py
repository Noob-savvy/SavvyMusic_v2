...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text=" ᴏᴡɴᴇʀ 💞", url=f"https://github.com/Noob-savvy"
            ),
        ],
        [
            InlineKeyboardButton(
            ...
            InlineKeyboardButton(text=" ᴄʜᴀᴛ 💌", url=f"https://t.me/wbn_chatmasti"),
        ],
        [
            InlineKeyboardButton(
                text=f"☀  ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ☀",
                url=f"https://github.com/Noob-savvy/SavvyRobot",
            )
        ],
    ]
    return buttons
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(text="ᴏᴡɴᴇʀ 💞", url=f"https://github.com/Noob-savvy"),
        ],
        [
            InlineKeyboardButton(
                text=_["PL_B_3"],
