...
import config
from SavvyMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app as bot
...
from SavvyMusic.utils.database import is_video_allowed
...
from SavvyMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from SavvyMusic.utils.inline.playlist import botplaylist_markup
from SavvyMusic.utils.logger import play_logs
from SavvyMusic.utils.stream.stream import stream
from config import BANNED_USERS, lyrical
from strings import get_command
from SavvyMusic.utils.database import is_served_user
...
@bot.on_callback_query(
    filters.regex("SavvyPlaylists") & ~BANNED_USERS
)
@languageCB
